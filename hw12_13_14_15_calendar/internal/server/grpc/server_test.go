...
func TestGRPCServer(t *testing.T) {
	...
	t.Run("grpc test create event and get event", func(t *testing.T) {
	...
	t.Run("grpc test create event and update event", func(t *testing.T) {
	...
	t.Run("grpc test create event and delete event", func(t *testing.T) {
